...
ndvi_co2 = pd.merge(gei_monthly, ndvi_avg, left_on='Time', right_on='Mes', how='inner')
ndvi_co2 = ndvi_co2[['Time', 'CO2_Avg', 'NDVI_Mean']]
print(ndvi_co2)
...
ax1.plot(ndvi_co2['Time'], ndvi_co2['CO2_Avg'], marker='o', color='blue', label='CO2 Avg')
ax1.tick_params(axis='y', labelcolor='blue')

# Create secondary y-axis
ax2 = ax1.twinx()
ax2.set_ylabel('NDVI', color='green')
ax2.plot(ndvi_co2['Time'], ndvi_co2['NDVI_Mean'], marker='x', color='green', label='NDVI Mean')
...
plt.title('Monthly CO2 vs NDVI (2024)')
